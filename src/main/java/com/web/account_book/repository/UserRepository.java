...
import com.web.account_book.model.TestUserModel;
...
public interface UserRepository extends JpaRepository<User, Long> {
    ...
    @Query(value = "SELECT new com.web.account_book.model.TestUserModel(u.username, u.email) FROM User AS u WHERE u.username LIKE :like")
    TestUserModel findByUsernameLike(@Param("like") String like);
}